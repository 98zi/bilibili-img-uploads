...
function srcWatch() {
  ...
  // watch(['src/adminPages/**/*.ejs'], series(compileEjs2, reload));
  // watch(['src/servePages/**/*.ejs'], series(compileEjs3, reload));
  watch(['public/**'], series(publicFile, reload));
  // watch(['src/index.js'], series(compileJs, reload));
  // watch(['src/utils/*.js'], series(compileJs, reload));
...
exports.build = series(distClean, parallel( compileEjs, publicFile));

exports.dev = series(distClean, parallel( compileEjs, publicFile), server, srcWatch);
